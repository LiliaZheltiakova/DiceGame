...
public static class DataStore
{
    ...
    private const string SOUND_VOLUME_STRING = "SoundVolume";
    ...
    static public void SaveOptions()
    {
        ...
        PlayerPrefs.SetFloat(MUSIC_VOLUME_KEY, Controller.Instance.Audio.SfxVolume);
    ...
    static public void LoadOptions()
    {
        ...
        Controller.Instance.Audio.SfxVolume = PlayerPrefs.GetFloat(MUSIC_VOLUME_KEY, DEFAULT_VOLUME);
    }
